...
To automatically determine parameters of the Kalman filter with machine learning and convex optimization. In other words, learning the parameters of the Kalman filter. That image(.gif) is an animation of the result. The animation show the estimated position of robot getting similar to the groundtruth.
